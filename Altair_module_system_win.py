...
# -*- coding: utf-8 -*-
"""
Altair Module System Unified GUI (Windows対応)
...
class AltairUnifiedGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Altair Module System Unified GUI (Windows対応)")
    ...
    def _build_ui(self):
        ...
        ttk.Combobox(conn_frame, textvariable=self.var_interface, 
                     values=("slcan", "pcan", "ixxat", "vector", "virtual"), width=10).grid(row=0, column=1, padx=5)
